...
<%@ page import="com.web.model.JobPost" %>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://google.co.in/">Contact</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-dark bg-dark text-white">
                <div class="card-body">
                    <h5 class="card-title">${myJobPost.jobProfile}</h5>
                    <p class="card-text">
                    ...
                    <p class="card-text">
                        ...
                        ${myJobPost.experience} years
                    </p>
                    <p class="card-text">
                        <strong>Tech Stack Required:</strong>
                        <ul>
                            <c:forEach var="tech" items="${myJobPost.techStack}">
                                <li>${tech}</li>
                            </c:forEach>
                        </ul>
                    </p>
